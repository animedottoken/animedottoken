-- Replace security definer views with security invoker functions
-- This approach ensures proper security context while maintaining functionality
...
-- These functions will run with the caller's privileges, respecting RLS

-- Collection like counts function
...
-- Collections public function (with masked addresses)
...
-- Creator collection like stats function
...
-- Creator NFT like stats function
...
-- Comprehensive creator stats function
...
GRANT EXECUTE ON FUNCTION public.get_collections_public() TO anon, authenticated;
...
GRANT EXECUTE ON FUNCTION public.get_boosted_leaderboard() TO anon, authenticated;
GRANT EXECUTE ON FUNCTION public.get_creators_public_stats() TO anon, authenticated;

-- Add helpful comments
COMMENT ON FUNCTION public.get_creators_public_stats() IS 'Secure function returning aggregated public statistics for creators';
COMMENT ON FUNCTION public.get_collections_public() IS 'Secure function returning active collections with masked creator addresses';
COMMENT ON FUNCTION public.get_boosted_leaderboard() IS 'Secure function returning real-time leaderboard of active boosted NFT listings';