-- Security Fix: Implement comprehensive security improvements (Fixed)
...
-- Create partial unique index for collection mint addresses (excluding nulls)
CREATE UNIQUE INDEX collections_collection_mint_address_unique_idx 
