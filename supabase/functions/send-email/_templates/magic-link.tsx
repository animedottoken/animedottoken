...
export const MagicLinkEmail = ({
  ...
  <Html>
    <Head />
    <Preview>Your magic link to ANIME.TOKEN</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Welcome to the ANIME.TOKEN community! Click the button below to sign in to your account.
        </Text>
