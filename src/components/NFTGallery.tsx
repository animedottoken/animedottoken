...
const additionalArtworks = [
  ...
  },
  {
    ...
    editionRemaining: "25",
    price: "1.2 ANIME",
    priceUSDC: "30.00 USDC",
    priceANIME: "736 390 ANIME",
  ...
  },
  {
    ...
    priceANIME: "1 227 317 ANIME",
    metadataUrl: "https://solscan.io/account/example15",
    status: "Limited",
    statusType: "limited" as const,
    isLimited: true,
    isExclusive: true,
  ...
  },
  {
    ...
    editionRemaining: "30",
    price: "1.5 ANIME",
    priceUSDC: "37.50 USDC",
    priceANIME: "920 487 ANIME",
    metadataUrl: "https://solscan.io/account/example16",
    status: "Available",
    statusType: "available" as const,
    isLimited: true,
    isExclusive: true,
  ...
  },
  {
    ...
    metadataUrl: "https://solscan.io/account/example17",
    status: "Available",
    statusType: "available" as const,
    isLimited: true,
    isExclusive: false,
      ...
      <Dialog open={!!selectedNFT} onOpenChange={() => setSelectedNFT(null)}>
        <DialogContent className="max-w-6xl h-[95vh] p-0">
          <div className="flex flex-col h-full">
            ...
            {selectedNFT && (
              <div className="flex flex-col lg:grid lg:grid-cols-3 gap-6 p-6 flex-1 overflow-auto">
                {/* Image Section */}
                ...
                <div className="flex flex-col h-full max-h-[70vh]">
                  ...
                  <div className="flex-1 overflow-auto space-y-4 pt-4 pr-2">
                    ...
                    {(selectedNFT as any).authorBio && (
                      <div>
                        <span className="text-sm text-muted-foreground block mb-2">Artist Bio</span>
