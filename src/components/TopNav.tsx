...
export const TopNav = () => {
  ...
  if (!isMobile) {
    return (
      <header ref={topNavRef} className="fixed top-16 left-0 fixed-avoid-scrollbar h-14 flex items-center justify-between border-b pl-4 pr-6 md:pr-8 bg-background/95 backdrop-blur-sm z-50">
        <Link 
          to="/"
          onClick={(e) => {
